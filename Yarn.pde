...
public class Yarn1
{
  ...
  public Yarn1()
  {
    yarn = loadImage("darkblueyarn transparentcropped.png"); // load the sprite of the yarn
    ...
    xSpeed = 1.7; // set the speed of the yarn
  }
  
  // Display the yarn on the screen:
  public void display()
  {
  ...
  { // When the user presses the retart button, this method is called
    xSpeed = 1.7; // set the speed to 1.7
